...
<head>
	...
	<link rel="icon" href="{{ asset('templates/Butterfly/favicon.png') }}" type="image/png">
	<link href="{{ asset('templates/Butterfly/css/bootstrap.css') }}" rel="stylesheet" type="text/css">
	<link href="{{ asset('templates/Butterfly/css/style.css') }}" rel="stylesheet" type="text/css">
	<link href="{{ asset('templates/Butterfly/css/linecons.css') }}" rel="stylesheet" type="text/css">
	<link href="{{ asset('templates/Butterfly/css/font-awesome.css') }}" rel="stylesheet" type="text/css">
	<link href="{{ asset('templates/Butterfly/css/responsive.css') }}" rel="stylesheet" type="text/css">
	<link href="{{ asset('templates/Butterfly/css/animate.css') }}" rel="stylesheet" type="text/css">

	<link href='https://fonts.googleapis.com/css?family=Lato:400,900,700,700italic,400italic,300italic,300,100italic,100,900italic' rel='stylesheet' type='text/css'>
	<link href='https://fonts.googleapis.com/css?family=Dosis:400,500,700,800,600,300,200' rel='stylesheet' type='text/css'>

	<script type="text/javascript" src="{{ asset('templates/Butterfly/js/jquery.1.8.3.min.js') }}"></script>
	<script type="text/javascript" src="{{ asset('templates/Butterfly/js/bootstrap.js') }}"></script>
	<script type="text/javascript" src="{{ asset('templates/Butterfly/js/jquery-scrolltofixed.js') }}"></script>
	<script type="text/javascript" src="{{ asset('templates/Butterfly/js/jquery.easing.1.3.js') }}"></script>
	<script type="text/javascript" src="{{ asset('templates/Butterfly/js/jquery.isotope.js') }}"></script>
	<script type="text/javascript" src="{{ asset('templates/Butterfly/js/wow.js') }}"></script>
	<script type="text/javascript" src="{{ asset('templates/Butterfly/js/classie.js') }}"></script>
	...
	<header id="header_outer">
		<div class="container">
			<div class="header_section">
				<div class="logo"><a href="javascript:void(0)"><img src="{{ asset('templates/Butterfly/img/logob.png') }}" alt=""></a></div>
		...
		<div class="portfolio">
			...
			<div class="isotope" style="position: relative; overflow: hidden; height: 480px;" id="portfolio-wrap">
				...
				<div style="position: absolute; left: 0px; top: 0px; transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;" class="portfolio-item one-four   videography isotope-item">
					<div class="portfolio-image"> <img src="{{ asset('templates/Butterfly/img/portfolio_pic1.jpg') }}" alt="Portfolio 1"> </div>
				...
				<div style="position: absolute; left: 0px; top: 0px; transform: translate3d(337px, 0px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;" class="portfolio-item one-four  design isotope-item">
					<div class="portfolio-image"> <img src="{{ asset('templates/Butterfly/img/portfolio_pic2.jpg') }}" alt="Portfolio 1"> </div>
					<div class="project-overlay">
				...
				<div style="position: absolute; left: 0px; top: 0px; transform: translate3d(674px, 0px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;" class="portfolio-item one-four  design  isotope-item">
					<div class="portfolio-image"> <img src="{{ asset('templates/Butterfly/img/portfolio_pic3.jpg') }}" alt="Portfolio 1"> </div>
					<div class="project-overlay">
				...
				<div style="position: absolute; left: 0px; top: 0px; transform: translate3d(1011px, 0px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;" class="portfolio-item one-four  photography  branding web isotope-item">
					<div class="portfolio-image"> <img src="{{ asset('templates/Butterfly/img/portfolio_pic4.jpg') }}" alt="Portfolio 1"> </div>
					<div class="project-overlay">
				...
				<div style="position: absolute; left: 0px; top: 0px; transform: translate3d(0px, 240px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;" class="portfolio-item one-four  design isotope-item">
					<div class="portfolio-image"> <img src="{{ asset('templates/Butterfly/img/portfolio_pic5.jpg') }}" alt="Portfolio 1"> </div>
					<div class="project-overlay">
				...
				<div style="position: absolute; left: 0px; top: 0px; transform: translate3d(337px, 240px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;" class="portfolio-item one-four  web isotope-item">
					<div class="portfolio-image"> <img src="{{ asset('templates/Butterfly/img/portfolio_pic6.jpg') }}" alt="Portfolio 1"> </div>
					<div class="project-overlay">
				...
				<div style="position: absolute; left: 0px; top: 0px; transform: translate3d(674px, 240px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;" class="portfolio-item one-four  design web isotope-item">
					<div class="portfolio-image"> <img src="{{ asset('templates/Butterfly/img/portfolio_pic7.jpg') }}" alt="Portfolio 1"> </div>
				...
				<div style="position: absolute; left: 0px; top: 0px; transform: translate3d(1011px, 240px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;" class="portfolio-item one-four   photography isotope-item">
					<div class="portfolio-image"> <img src="{{ asset('templates/Butterfly/img/portfolio_pic8.jpg') }}" alt="Portfolio 1"> </div>
...
-->
		...
		<div class="client_area ">
			<div class="client_section animated  fadeInUp wow">
				<div class="client_profile">
					<div class="client_profile_pic"><img src="{{ asset('templates/Butterfly/img/client-pic1.jpg') }}" alt=""></div>
					<h3>Saul Goodman</h3>
					<span>Lawless Inc</span> </div>
				<div class="quote_section">
					<div class="quote_arrow"></div>
					<p><b><img src="{{ asset('templates/Butterfly/img/quote_sign_left.png') }}" alt=""></b> Proin iaculis purus consequat sem cure digni ssim donec porttitora entum suscipit rhoncus. Accusantium quam, ultricies eget id, aliquam eget nibh et. Maecen aliquam, risus at semper. <small><img src="{{ asset('templates/Butterfly/img/quote_sign_right.png') }}" alt=""></small>						</p>
				</div>
				<div class="clear"></div>
			</div>
			<div class="client_section animated  fadeInDown wow">
				<div class="client_profile flt">
					<div class="client_profile_pic"><img src="{{ asset('templates/Butterfly/img/client-pic2.jpg') }}" alt=""></div>
	...
	<div class="c-logo-part">
		...
		<div class="container">
			<ul class="delay-06s animated  bounce wow">
				<li><a href="javascript:void(0)"><img src="{{ asset('templates/Butterfly/img/c-liogo1.png') }}" alt=""></a></li>
				<li><a href="javascript:void(0)"><img src="{{ asset('templates/Butterfly/img/c-liogo2.png') }}" alt=""></a></li>
				<li><a href="javascript:void(0)"><img src="{{ asset('templates/Butterfly/img/c-liogo3.png') }}" alt=""></a></li>
				<li><a href="javascript:void(0)"><img src="{{ asset('templates/Butterfly/img/c-liogo5.png') }}" alt=""></a></li>
			</ul>
		</div>
	</div>
	<!--c-logo-part-end-->
			...
			<div class="team-leader-block clearfix">
				<div class="team-leader-box">
					<div class="team-leader wow fadeInDown delay-03s">
						...
						<img src="{{ asset('templates/Butterfly/img/team-leader-pic1.jpg') }}" alt="">
						<ul>
				...
				<div class="team-leader-box">
					<div class="team-leader  wow fadeInDown delay-06s">
						<div class="team-leader-shadow"><a href="javascript:void(0)"></a></div>
						<img src="{{ asset('templates/Butterfly/img/team-leader-pic2.jpg') }}" alt="">
						<ul>
							<li><a href="javascript:void(0)" class="fa-twitter"></a></li>
							<li><a href="javascript:void(0)" class="fa-facebook"></a></li>
							<li><a href="javascript:void(0)" class="fa-pinterest"></a></li>
				...
				<div class="team-leader-box">
					<div class="team-leader wow fadeInDown delay-09s">
						<div class="team-leader-shadow"><a href="javascript:void(0)"></a></div>
						<img src="{{ asset('templates/Butterfly/img/team-leader-pic3.jpg') }}" alt="">
						<ul>
							<li><a href="javascript:void(0)" class="fa-twitter"></a></li>
							<li><a href="javascript:void(0)" class="fa-facebook"></a></li>
							<li><a href="javascript:void(0)" class="fa-pinterest"></a></li>
	...
	<footer class="footer_section" id="contact">
              ...
              Albuquerque, NM, 87104 </span> </div>
						...
						<div class="col-lg-4">
							<div class="contact_block">
								...
								<span> <a href="mailto:hello@astrowebstudio.com"> hello@astrowebstudio.com</a> </span> </div>
						</div>
					</div>
				</div>
				<div class="row">
		...
		<div class="container">
			<div class="footer_bottom">
				<span>© We Work</span>
				<div class="credits">
					Powered by <a href="https://astrowebstudio.com/">Astroweb Studio</a> 
				</div>
			</div>
		</div>
	</footer>
	...
	<script src="{{ asset('templates/Butterfly/contactform/contactform.js') }}"></script>
